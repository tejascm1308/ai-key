...
# Complete System Architecture - All Modules

Based on the four documents, here's the comprehensive module breakdown of your AI Keyboard system:

## 🧠 Core Intelligence Modules

### 1. **Short-Term Memory (STM) Manager**[^2_1][^2_2]
...
### 2. **Long-Term Memory (LTM) System**[^2_2][^2_1]
...
### 3. **Mood Estimation Engine**[^2_1][^2_2]
...
### 4. **Clipboard Intelligence System**[^2_1]

- Clipboard monitor
- Content type detector (text/image/file)
- Relevance scorer (5-factor algorithm)
...
### 5. **LLM Orchestration Layer**[^2_2][^2_1]

- Prompt builder
- Context transformer (STM → prompt)
- Cloud LLM client (OpenAI/Anthropic)
- Local LLM client (Ollama/TinyLlama)
- Fallback manager (cloud → local)
- Streaming handler
- Response validator


### 6. **Suggestion Quality Pipeline**[^2_1]

- Pre-flight checker (context sufficient? app allowed?)
- Post-processor (repetition check, confidence validation)
- Threshold tuner (mood-based, acceptance rate-based)
- Delivery decision maker


### 7. **Feedback Learning Module**[^2_2]
...
### 9. **Application Context Detector**[^2_3]
...
### 14. **Cross-App Workflow Tracker**[^2_4]
...
### 17. **Native Messaging Bridge**[^2_4]
...
### 18. **Custom IME (Input Method Editor)**[^2_4]
...
### 22. **Encryption Module**[^2_4]

- STM local encryption (AES-256)
- Secure key storage
- Data sanitization


### 23. **Privacy Controller**[^2_4]
...
### 24. **MCP (Model Context Protocol) Server**[^2_2]
...
### 25. **Context Synchronizer**[^2_1][^2_2]

- STM update coordinator
- Event queue manager
- Debounce controller (300ms for keystrokes)
...
### 27. **User Preferences Manager**[^2_2][^2_4]
...
### 28. **Context Window Configuration**[^2_4]
...
### 29. **Suggestion Settings Controller**[^2_1]

- Base threshold configuration
- Mood adjustment settings
...
### 30. **Performance Metrics Tracker**[^2_2]
...
### 31. **Session Analytics**[^2_1]

- Session duration tracker
- Typing statistics (WPM baseline)
- App usage patterns
- Productivity window detector


### 32. **Logging \& Debug Module**
...
### 35. **Prompt Template Manager**[^2_1]

- Template storage (document writing, email, code)
- Template selector
- Variable injector
- Context-aware template builder


### 36. **Timing \& Debounce Controller**[^2_2]

- Adaptive delay calculator
- Natural pause detector
...
### 37. **Email Composer Assistant**[^2_1]
...
### 39. **Document Writing Assistant**[^2_1]
...
### 40. **Chat/Messaging Assistant**[^2_1]
...
### 41. **System Tray Application**[^2_4]
...
### 43. **Onboarding Module**

- First-run wizard
- Permission requester
- Baseline calibrator (initial typing speed)
- Tutorial/guide

***

## Total Module Count: **43 Modules**

### Module Categories Summary:

| Category | Count |
| :-- | :-- |
| **Core Intelligence** | 7 modules |
| **Desktop Application** | 7 modules |
| **Browser Extension** | 3 modules |
| **Mobile** | 3 modules |
| **Backend Infrastructure** | 3 modules |
| **Integration \& Communication** | 3 modules |
| **Configuration \& Control** | 3 modules |
| **Analytics \& Monitoring** | 3 modules |
| **Utility \& Helpers** | 4 modules |
| **Workflow-Specific** | 4 modules |
| **System Integration** | 3 modules |
...
┌─────────────────────────────────────────────────────────────┐
│                    PRESENTATION LAYER                       │
│  Desktop Overlay | Browser Extension | Mobile Keyboard UI  │
│     (8-14)       |      (15-17)      |      (18-20)        │
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
│                   ORCHESTRATION LAYER                       │
│  Event Bus | Context Sync | MCP Server | Privacy Control   │
│   (26)     |     (25)     |    (24)    |      (23)         │
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
│                  CORE INTELLIGENCE LAYER                    │
│  STM | LTM | Mood | Clipboard | LLM | Quality | Feedback   │
│  (1) | (2) | (3)  |    (4)    | (5) |   (6)   |    (7)     │
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
│                   WORKFLOW ASSISTANTS                       │
│    Email (37) | Code (38) | Document (39) | Chat (40)      │
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
│                    DATA & STORAGE LAYER                     │
│    MongoDB (21) | Encryption (22) | Metrics (30-31)        │
└─────────────────────────────────────────────────────────────┘
```

Ready to deep-dive into any specific module?[^2_3][^2_2][^2_1][^2_4]

<div align="center">⁂</div>

[^2_1]: CORE_INTELLIGENCE_DESIGN.md

[^2_2]: ai_keyboard_sol.md

[^2_3]: GRAMMARLY_TECHNICAL_RESEARCH.md

[^2_4]: SOLUTION_DECISIONS.md
